...
export function Icon({ name, size = 16, stroke = 1.6 }: { name: string; size?: number; stroke?: number }) {
  ...
  switch (name) {
    ...
    case 'pencil': return <svg {...common}><path d="M4 20h4L20 8a2.83 2.83 0 00-4-4L4 16v4z"/><path d="M14.5 5.5l4 4"/></svg>;
    case 'note': return <svg {...common}><path d="M6 3h9l5 5v13a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1z"/><path d="M14 3v5h5M9 13h6M9 17h6"/></svg>;
    case 'download': return <svg {...common}><path d="M12 3v12M5 12l7 7 7-7"/><path d="M5 21h14"/></svg>;
